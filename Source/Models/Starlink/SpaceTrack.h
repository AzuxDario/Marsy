...
namespace Marsy::Models::Starlink
{
    struct SpaceTrack
    {
        ...
        std::optional<float> inclination = std::nullopt;
        std::optional<float> raOfAscNode = std::nullopt;
        std::optional<float> ArgOfPericenter = std::nullopt;
        ...
        std::optional<float> bstar = std::nullopt;
        std::optional<float> meanMotionDot = std::nullopt;
        std::optional<float> meanMotionDdot = std::nullopt;
        std::optional<float> semimajorAxis = std::nullopt;
        std::optional<float> period = std::nullopt;
        std::optional<float> apoapsis = std::nullopt;
        std::optional<float> periapsis = std::nullopt;
